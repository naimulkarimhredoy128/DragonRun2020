...
public class Level1AState extends GameState {
	...
	public Level1AState(GameStateManager gsm) {
		super(gsm); ///game state manager
		init();
	}
	
        ///asbtract method in gamestate class
	public void init() {
		
		// backgrounds
		sky = new Background("/Backgrounds/mysky2.gif", 0);
		...
		// music
		JukeBox.load("/Music/closer.mp3", "level1");
		JukeBox.loop("level1", 600, JukeBox.getFrames("level1") - 200);
	...
	public void update() {
		...
		// update tilemap background tiles
		tileMap.setPosition(
