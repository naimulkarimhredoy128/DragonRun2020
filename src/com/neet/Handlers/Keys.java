...
public class Keys {
	...
	public static void keySet(int i, boolean b) {
		...
		else if(i == KeyEvent.VK_W) keyState[BUTTON1] = b;//flying
		else if(i == KeyEvent.VK_A) keyState[BUTTON2] = b;//walkspeed
		else if(i == KeyEvent.VK_SPACE) keyState[BUTTON3] = b; //fireball
		else if(i == KeyEvent.VK_D) keyState[BUTTON4] = b;//fireballmax
